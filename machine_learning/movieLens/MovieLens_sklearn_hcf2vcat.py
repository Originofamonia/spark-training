...
def hcf_inference(t_hat, training, test, rating_shape, pr_curve_filename):
    ...
    return auc_score, t1_hat_norm, t2_hat_norm, r_hat
...
def main():
    ...
    for rank, num_iter in itertools.product(ranks, num_iters):
        ...
        valid_auc, t1_hat_norm, t2_hat_norm, r_hat = hcf_inference(t_hat, training, test, (6041, 3953), pr_curve_filename)
        sim_matrix = diversity(np.dot(t1_hat_norm.T, t1_hat_norm), r_hat)
